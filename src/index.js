...
ReactDOM.render(
  // con este store estoy conectando toda la app para que pued tener el encapsulado de la data inicial, y utiliznado el conect puedo extraer la info del estado para poder presentarla en la app
